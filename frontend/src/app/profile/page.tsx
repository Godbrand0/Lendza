...
import {
  ...
  Eye, Loader2, Timer, ShieldCheck, TrendingDown, TrendingUp, AlertCircle,
} from "lucide-react";
...
export default function ProfilePage() {
  ...
  // Live countdown for active loans
  ...
  const isLender = position.lenderUsdc !== null;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="glass p-8 space-y-5">
            ...
            {!position.hasCollateral ? (
              ...
              <div className="space-y-4">
                ...
                {/* Debt amount — encrypted, reveal button */}
                {position.loan?.isActive && (
          ...
          <div className="glass p-8 space-y-5">
            ...
            {position.lenderUsdc !== null && position.lenderUsdc > 0 && (
